  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (res.data.requires2FA) {
        router.push(`/login?userId=${res.data.userId}&newAccount=true`);
      } else {
...
const s = {
  ...
  brand:      { fontSize:13, fontWeight:600, color:'#888', textAlign:'center', marginBottom:20, letterSpacing:'0.05em', textTransform:'uppercase' },
